...
@synthesize receiveDataParams = _receiveDataParams;
@synthesize transferDataParams = _transferDataParams;
@synthesize subTransferDataParams = _subTransferDataParams;
@synthesize baseNavigationController = _baseNavigationController;
@synthesize passValueDelegate = _passValueDelegate;
@synthesize titleText = _titleText;
@synthesize rightBarImage = _rightBarImage;
@synthesize rightBarButtonOnClick = _rightBarButtonOnClick;
@synthesize isDismissKeyboard = _isDismissKeyboard;
@synthesize isLeftBtnBackHidden=_isLeftBtnBackHidden;
@synthesize ges = _ges;
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    if(_rightBarImage!=nil){
        [[self baseNavigationController] rightImageBarButtonItem:self rightImageButton:_rightBarImage];
    }
}
